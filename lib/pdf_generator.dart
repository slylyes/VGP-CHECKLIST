...
// Clé pour persister le numéro de rapport
const String _rapportCounterKey = 'numero_rapport_counter';

Future<int> _getNextNumeroRapport() async {
  final prefs = await SharedPreferences.getInstance();
  final current = prefs.getInt(_rapportCounterKey) ?? 0;
  final next = current + 1;
  await prefs.setInt(_rapportCounterKey, next);
  return next;
}
          ...
          children: [
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text('Client : ${rapport.nomClient}', style: boldStyle.copyWith(fontSize: 8)),
            ...
            if (conditionsItems.isNotEmpty)
               _buildConditionsTableCompact(conditionsItems, boldStyle, customStyle),
      ...
      build: (pw.Context context) {
        return pw.Column(
          ...
          children: [
            // Logo
            pw.Center(
              child: pw.Image(logoImage, width: 65, height: 45, fit: pw.BoxFit.contain),
            ),
            pw.SizedBox(height: 3),
                ...
                pw.Expanded(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      _buildInfoRowFinal('Nom :', 'RENAI KOUCEILA', boldStyle, customStyle),
                ...
                pw.Expanded(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Divider(color: primaryColor, height: 2),
                      _buildInfoRowFinal('Client :', rapport.nomClient, boldStyle, customStyle),
                      ...
                      pw.Divider(color: primaryColor, height: 2),
                      _buildInfoRowFinal('Nom :', rapport.nomResponsable ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Société :', rapport.societeResponsable ?? '', boldStyle, customStyle),
                ...
                pw.Expanded(
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Divider(color: primaryColor, height: 2),
                      _buildInfoRowFinal('Marque :', rapport.marqueModele, boldStyle, customStyle),
                      _buildInfoRowFinal('Modèle :', rapport.typeVehicule ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Type :', rapport.typeVehicule ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Catégorie :', rapport.categorieVehicule ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('N° Série :', rapport.numeroSerie ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('N° Immatriculation :', rapport.immatriculation, boldStyle, customStyle),
                      _buildInfoRowFinal('Accessoires :', rapport.accessoires ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Charge max de levage :', rapport.chargeMaxiLevage ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Année de fabrication :', rapport.anneeFabrication ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Marquage CE :', rapport.marquageCE ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Compteur Horamètre :', rapport.compteurHorametre ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('N° Parc :', rapport.numeroParc ?? '', boldStyle, customStyle),
                      _buildInfoRowFinal('Kilométrage :', '${rapport.kilometrage} km', boldStyle, customStyle),
                    ],
                  ),
                ),
              ],
    ...
    children: [
      ...
      ...contentItems.map((item) {
        ...
        return pw.TableRow(
          children: [
            _buildCompactCell(item.titre, style),
            _buildCompactCell(item.status == ColonneStatus.b ? 'X' : '', style, alignment: pw.Alignment.center),
            _buildCompactCell(item.status == ColonneStatus.d ? 'X' : '', style, alignment: pw.Alignment.center),
